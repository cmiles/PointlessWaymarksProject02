...
public partial class App
{
    public App()
    {
        LogTools.StandardStaticLoggerForDefaultLogDirectory("PwPhotoMetadataBasics");
    ...
    public static bool HandleApplicationException(Exception ex)
    {
        ...
        var res = MessageBox.Show(msg, "Photo Metadata Basics App Error", MessageBoxButton.YesNo,
