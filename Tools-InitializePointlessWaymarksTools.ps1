...
if ($userName) {
    ...
    fossil clone http://$userName@localhost:8080/pointless-waymarks-tools pointless-waymarks-tools.fossil
} else {
    # Run the fossil clone command without the username
    fossil clone http://localhost:8080/user/cmiles/repository/pointless-waymarks-tools pointless-waymarks-tools.fossil
}
