...
public static class LineGenerator
{
    ...
    public static async Task<LineContent> NewFromGpxTrack(GpsTrackInformation trackInformation,
    ...
    public static async Task<LineContent> NewFromGpxTrack(GpsRouteInformation trackInformation,
