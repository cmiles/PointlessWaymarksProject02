...
/// <summary>
///     Helpers for managing Cloud Storage Credentials tied to the current CMS User Settings. Credentials are stored in a Password
///     Vault.
///     If you are not in a situation where you are using valid CMS User Settings use the CloudStorageCredentials class
///     instead.
/// </summary>
public static class CloudStorageCredentialsFromUserSettings
{
    /// <summary>
